...
<body>
	<div class="Competence_add_style clearfix">
		<form action="{{Route('pri_doadd')}}" method="post">
			@csrf
			<div class="left_Competence_add">
				...
				<div class="Competence_add">
					<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 权限名称 </label>
						<div class="col-sm-9"><input type="text" id="form-field-1" placeholder="" name="privilege_name" class="col-xs-10 col-sm-5"></div>
					</div>
					<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 权限路径 </label>
						<div class="col-sm-9"><textarea name="privilege_path" class="form-control" id="form_textarea" placeholder="" onkeyup="checkLength(this);"></textarea><span
							class="wordage">剩余字数：<span id="sy" style="color:Red;">200</span>字</span></div>
					</div>
					<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 角色选择 </label>
						<div class="col-sm-9">
						@foreach($data as $v)
								<label class="middle">
									<input type="radio" name="role_name" id="id-disable-check" value="{{$v->id}}">
									<span class="lbl">{{$v->role_name}}</span>
								</label>
						@endforeach
						</div>
					</div>
