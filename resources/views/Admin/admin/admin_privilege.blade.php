...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       <span class="l_f">
        <a href="{{Route('pri_add')}}" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i> 添加权限</a>
			...
			<tr>
             ...
             <tbody>
			  ...
			  <tr>
				...
				<td>{{$v->id}}</td>
				<td>{{$v->privilege_name}}</td>
				<td class="hidden-480">{{$v->privilege_path}}</td>
				<!-- <td>{{$v->privilege_name}}</td> -->
				<td>
                 <a title="编辑" onclick="Competence_modify('560')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120">编辑</i></a>        
                 <a title="删除" href="{{route('privilege_del',['id'=>$v->id])}}"  onclick="Competence_del(this,'1')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120">删除</i></a>
				</td>
			   </tr>
			   @endforeach
               <!-- <tr>
