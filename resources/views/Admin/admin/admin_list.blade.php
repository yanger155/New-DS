			...
			<div class="d_Confirm_Order_style">
				...
				<div class="border clearfix">
					<span class="l_f">
						...
						<a href="javascript:ovid()" id="administrator_add" class="btn btn-warning"><i class="fa fa-plus"></i> 注册用户</a>
							...
							<div class="widget-box side_content">
								...
								<div class="side_list">
									<div class="widget-header header-color-green2">
										<h4 class="lighter smaller">管理员role列表</h4>
									</div>
